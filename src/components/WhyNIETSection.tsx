      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        >
          <h2 className="text-4xl lg:text-6xl text-gray-900 mb-6 tracking-tight">
            Why <span className="bg-gradient-to-r from-[#0b4c78] to-cyan-500 bg-clip-text text-transparent">500+ Graduates</span>
            <br />
            Trust NIET
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Nepal's Best Private College Award winner. First UGC-QAA certified engineering college in Kathmandu Valley. Proven track record of global success.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-6 lg:gap-8">
            {["Cambridge University", "Mayo Clinic", "Nanyang Tech", "AstraZeneca", "IIT India", "Grande Hospital"].map((partner, index) => (
              <div
                key={index}
                className="px-6 py-3 rounded-2xl bg-gradient-to-br from-gray-50 to-white border border-gray-200 hover:border-[#0b4c78]/30 hover:shadow-lg transition-all"
              >
